        ...
        <div class="weui-cells">
            <div class="weui-cell">
                <div class="weui-cell__bd" id="name">
                    <form action="${urlPath}/mobile/person/changeAddress.action" method="post">
                        <div class="change_address">
                            <span>收货人姓名:</span>
                            <input class="weui-input address_input" name="name" type="text" value="${name}">
                            <input type="hidden" name="id" value="${aid}">
                        </div>
                        <div class="change_address">
                            <span>手机:</span>
                            <input class="weui-input address_input" id="phone" onblur="checkPhone()" name="phone" type="text" value="${phone}">
                        </div>
                        <div class="change_address">
                            <span>地址:</span>
                            <input type="text" id='city-picker' class="address_input" name="address" style="margin-top: -0.3em;" placeholder="${address}"/>
                            <script>
                                $(function () {
                        ...
                        <div class="weui-cells weui-cells_form">
                            <div class="weui-cell">
                                <div class="weui-cell__bd">
                                    <textarea class="weui-textarea detailed_address" name="addr" placeholder="详细地址必填" rows="3"></textarea>
                                    <div class="weui-textarea-counter"><span>0</span>/200</div>
                                </div>
                            </div>
                        </div>
                        <input type="submit" value="确定修改" class="weui-btn weui-btn_primary newaddress_btn">
